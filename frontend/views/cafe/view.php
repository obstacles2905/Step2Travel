...
?>
<div id="cafe_marker"></div>
<div id="container">
    <div id="bread_crumbs"></div>

    <div id="cafe_name_and_panoram">
        <img class="name_and_panoram_bg" src="/image/video.jpg" alt="">
        <div id="cafe_name_and_panoram_react"></div>
         <div class="panoram"> 
    ...
    <div id="cafe_map">
        <div id="map"></div>
        <!-- <ul class="cafe_buttons">
                <li id="whereEat" class="cafe_map_button_foot">Де поїсти</li>
                <li id="whereSleep" class="cafe_map_button_house">Де зупимитися</li>
            </ul> -->
    </div>
