...
use backend\models\PointCategoryForm;
...
class PointcategoryController extends Controller
{
    ...
    public function __construct($id, $module, PointCategoryService $service, array $config = [])
    {
    ...
    {
        $form_main = new PointCategoryForm();
    ...
    public function actionDelete($id)
    {
        try {
            ...
            \Yii::$app->session->setFlash('error', 'delete point category failed!');
        }
        return $this->redirect(['index']);
    }
